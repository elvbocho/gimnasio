        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-dark text-white">
                    <h4 class="mb-0"><i class="fas fa-dumbbell"></i> Crear Rutina de Entrenamiento</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('rutinas-entrenamiento.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-success"><i class="fas fa-save"></i> Crear Rutina</button>
                        </div>
                    </form>
                </div>
            </div>
